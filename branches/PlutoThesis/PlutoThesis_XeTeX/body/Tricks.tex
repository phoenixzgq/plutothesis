...
\specialrule{1.4pt}{0pt}{2pt}%\hline\hline
...
\begin{table}[htbp]
\centering \wuhao %注意表格的文字是五号的，表格环境前后分别加上 \wuhao , \defaultfont 这两个命令。
...
\wuhao %注意表格的文字是五号的，表格环境前后分别加上 \wuhao , \defaultfont 这两个命令。
\begin{longtable}{lll} 
