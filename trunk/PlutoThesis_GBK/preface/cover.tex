...
\newcommand{\englishthesistitle}{\uppercase{\LaTeX~Dissertation Template of \\Harbin Institute of Technology~(Version \version)}} %\uppercase作用：将英文标题字母全部大写；
...
\ckeywords{\LaTeX{}；论文模板；哈工大；(3 $\sim$ 6 个!) }
