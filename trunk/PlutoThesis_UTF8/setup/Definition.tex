...
\fi
\newcommand{\song}{\CJKfamily{gbsn}}    % 宋体   (Windows自带simsun.ttf) song
\newcommand{\fs}{\CJKfamily{gbsn}}        % 仿宋体 (Windows自带simfs.ttf) fs
\newcommand{\kai}{\CJKfamily{gbsn}}      % 楷体   (Windows自带simkai.ttf) kai
\newcommand{\hei}{\CJKfamily{gbsn}}      % 黑体   (Windows自带simhei.ttf) hei
