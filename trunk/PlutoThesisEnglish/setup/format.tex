...
\titleformat{\chapter}[hang]{\xiaoer\bf\filcenter\hei\sf}{\xiaoer\chaptertitlename}{18pt}{\xiaoer}
...
\ifoneortwoside
  ...
  \fancyhead[CE]{\CJKfamily{song}\xiaowu Dissertation for the \exueweier { } Degree in \exueke, HIT }%
  \fancyfoot[C,C]{\xiaowu--~\thepage~--}
\else%
  \fancyhead[CO]{\CJKfamily{song}\xiaowu Dissertation for the \exueweier { } Degree in \exueke, HIT }%
  \fancyhead[CE]{\CJKfamily{song}\xiaowu Dissertation for the \exueweier { } Degree in \exueke, HIT }%
  \fancyfoot[C,C]{\xiaowu--~\thepage~--}
\fi
...
\def\makecover{
    ...
    \begin{center} {\song \cxuewei 学位论文 }\end{center} }
    ...
    ~ & {\hei \xueweishort \hfill士\hfill研究生：}           & \@cauthor\\
...
\clearpage \chapter*{摘~~~~要} %不要挪到下一行，生成正确的摘要toc
...
%%%%%%%%%%%%%%%%%%%   English Abstract  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\defaultfont \chapter*{\textbf{Abstract}} %不要挪到下一行，生成正确的摘要toc
