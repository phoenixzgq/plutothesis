...
本版本在图表的长标题自动断行,缩进量上存在问题，图表目录上第二行也总比第一行的标题多出0.25个空格左右的距离，算是一个问题。

其他未知待解决的问题还有赖于大家的使用和发现。
...
\end{hitlist}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\BiSection{版本升级至1.4~(by nebula)}{Version Update(by nebula)}
...
\end{hitlist}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\BiSection{版本升级至1.5~(by nebula)}{Version Update(by nebula)}
...
\end{hitlist}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\BiSection{版本升级至1.6~(by luckyfox)}{Version Update(by
luckykfox)}
...
\item nebula先后完善模板为1.4、1.5版本。
\item luckyfox完善模板为1.6版本。
