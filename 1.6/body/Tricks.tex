...
模板中使用的是紫丁香网友~jdg~提供的~chinesebst.bst，参考文献问题全部解决。
...
如果某图题很长的话，可以通过局部改变\verb|\captionwidth|的宽度进行断行。图~\ref{Figure:Tricks:Example11}给出了一个中英文标题过长的例子。

\begin{figure}
\centering
\includegraphics[width = 0.4\textwidth]{golfer}
\changecaptionwidth \captionwidth{0.6\textwidth}
...
\centering
\includegraphics[width = 0.4\textwidth]{golfer}
\FigureBiCaption{打高尔夫球的人打高尔夫球的人打高尔打高尔夫球的人  打高尔夫球的人打高尔夫球的人打高尔夫球的人打高尔夫球的人}{ Golfer Golfer Golfer Golfer Golfer Golfer   Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer} \label{Figure:Tricks:Example12}
\end{figure}
...
\SubfigureCaption{0.9\textwidth}{Golfer1 Golfer1 Golfer1 Golfer1
Golfer1}
\end{minipage}
\begin{minipage}{0.25\textwidth}
\centering
\subfigure[高尔夫高尔夫高尔夫高尔夫高尔夫２]{\label{Figure:Tricks:Example31:B}
  \includegraphics[width = \textwidth]{golfer}
}\\
\SubfigureCaption{0.9\textwidth}{Golfer2 Golfer2 Golfer2 Golfer2
Golfer2 Golfer2}
\end{minipage}
\begin{minipage}{0.25\textwidth}
\centering
\subfigure[高尔夫高尔夫高尔夫高尔夫高尔夫3]{\label{Figure:Tricks:Example31:C}
  \includegraphics[width = \textwidth]{golfer}
}\\
\SubfigureCaption{0.9\textwidth}{Golfer3 Golfer3 Golfer3 Golfer3
Golfer3 Golfer3}
\end{minipage}
