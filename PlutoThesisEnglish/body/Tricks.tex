...
\chapter{Some Tricks of Using this Template}
\label{Tricks}

\section{Something About Templates}
...
\subsection{Necessary to Use Templates？}
...
\subsection{Which Templates I should Select？}
...
\subsubsection{Word Templates} 现在校内流行的~ word 模板
...
\section{Readme}
\subsection{Environment of Software}
...
\subsection{Downloading and Updating Methods of Updated Template}
\subsubsection{Template Downloading Method}
...
\subsubsection{Template Updating Method}
...
\section{Doctor or Master Thesis}
...
\section{Chinese and English Contents}
...
上述~4 个命令的使用方法如~\verb"\BiChapter{中文标题}{engish}" 和 ~\verb"\section{中文标题}{engish}"所示。
...
文献~ \ucite{Lin1992,McDonnell1994,Yao1993,Chen1992,Niwa1990,wu1997} 是根据哈尔滨工业大学的论文规范
里的参考文献示例的条目给出的。
...
\section{Chinese and English Caption of Figures and Tables}
\label{Tricks:Captions}
\subsection{Caption of Figures}
模板中为图定义了双标题命令：
\begin{verb}
...
\caption{Golfer Golfer This is a very good idea and i
...
\centering
\includegraphics[width = 0.4\textwidth]{golfer}
\caption{Golfer Golfer Golfer Golfer Golfer Golfer   Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer Golfer}
...
\begin{figure}[htbp]
\centering
\subfigure[Golfer 2]{\label{Figure:Tricks:Example2:a}
  \includegraphics[width = 0.22\textwidth]{golfer}
}
\subfigure[Golfer 1]{\label{Figure:Tricks:Example2:B}
  \includegraphics[width = 0.22\textwidth]{golfer}
}
\caption{Golf}
...
\centering
\subfigure[Golfer1]{\label{Figure:Tricks:Example3:a}
  \includegraphics[width = \textwidth]{golfer}
}\vspace*{-5pt}
\end{minipage}
\begin{minipage}{0.25\textwidth}
\centering
\subfigure[Golfer2]{\label{Figure:Tricks:Example3:B}
  \includegraphics[width = \textwidth]{golfer}
}\vspace*{-5pt}
\end{minipage}
\begin{minipage}{0.25\textwidth}
\centering
\subfigure[Golfer3]{\label{Figure:Tricks:Example3:C}
  \includegraphics[width = \textwidth]{golfer}
}\vspace*{-5pt}
\end{minipage}
\caption{Golf}
...
\centering
\subfigure[Golfer1 Golfer1 Golfer1 Golfer1 Golfer1]{\label{Figure:Tricks:Example31:a}
  \includegraphics[width = \textwidth]{golfer}
}\SubfigEnCaption{}
\end{minipage}\hspace{2em}
\begin{minipage}[t]{0.20\textwidth}
\centering
\subfigure[G G f f f f f f f f f f f f f f f f f f]{\label{Figure:Tricks:Example31:B}
  \includegraphics[width = \textwidth]{golfer}
}
\end{minipage}\hspace{2em}
\begin{minipage}[t]{0.20\textwidth}
\centering
\subfigure[Golfer3 Golfer3 Golfer3 Golfer3 Golfer3 Golfer3]{\label{Figure:Tricks:Example31:C}
  \includegraphics[width = \textwidth]{golfer}
}
\end{minipage}
\caption{Parent: Golf Golf Golf Golf Golf}
\label{Figure:Tricks:Example31}
\end{figure}


\subsection{Caption of Tables}
模板中分别为表定义了双标题命令：
...
\begin{longtable}{lll}
%\LTBiTocCaption{中文标题短}{中文标题长}{Table}{Long Table  Short Caption}{Long Table Long Caption}
\caption{Long table}
\label{table:LTexample}\\
...
\section{A Long Section Title Example}\label{tricks:Longsectiontitle}
